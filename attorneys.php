...
<main>
    <section class="page-header">
        <div class="container">
            ...
            <p>Experienced, passionate lawyers committed to serving disadvantaged communities</p>
        </div>
    </section>
            ...
            <div class="team-grid">
                ...
                <div class="team-member">
                    ...
                    <div class="member-info">
                        ...
                        <div class="member-contact">
                            <p><i class="fas fa-envelope"></i> lerato@justiceforall.com</p>
                            <p><i class="fas fa-phone"></i> +27 12 345 6782</p>
                        </div>
                    </div>
                </div>
                <div class="team-member">
